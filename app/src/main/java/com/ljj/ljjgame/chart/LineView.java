...
//    private List<String> yList = new ArrayList<>();
     ...
     * y轴固定间隔数值
     */
//    private List<String> yShalfList = new ArrayList<>();
...
//    private int bgColor = 0x66000000;
     ...
     * 刻度值字体大小
     */
    private int scaleTxtSize = 8;
    /**
     * 刻度字体颜色
     */
    private int scaleTxtColor = 0x66000000;
...
//    private int innCircleColor =0xffffffff;
    private int innCircleColor =0xff2791dc;
...
//        }
    ...
    private void drawLeftText(Canvas canvas) {
        ...
        yGap = showLineAreaHeight/(yGapSize+1); //2顶部和尾部空出一个格子
//        for (Float aFloat : yShalfList) {
//            canvas.translate(0,-yGap);
//            int  ss = Math.round(aFloat);
////            String  s= String.valueOf(aFloat);
////            int ss= Integer.parseInt(s);
//
//            canvas.drawText(ss+"",0,0,scaleTxtPaint);
////            canvas.drawText(aFloat+" -",0,0,scaleTxtPaint);
//        }
        for(int i = 0;i<11;i++){
            canvas.translate(0,-yGap);
            canvas.drawText(i*10+"",0,0,scaleTxtPaint);
        }
        canvas.restore();
    }
