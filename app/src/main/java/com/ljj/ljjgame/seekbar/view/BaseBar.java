package com.ljj.ljjgame.seekbar.view;
...
import static com.ljj.ljjgame.seekbar.view.CustomSeekBarUtils.dp2px;
...
public abstract class BaseBar extends View {
    ...
    public void initParams(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStartColor = seekArray.getColor(R.styleable.BaseBar_startColor, ContextCompat.getColor(context, R.color.endColor));
        mCenterColor = seekArray.getColor(R.styleable.BaseBar_centerColor, ContextCompat.getColor(context, R.color.endColor));
        ...
        mCircleColor = seekArray.getColor(R.styleable.BaseBar_circleColor, ContextCompat.getColor(context, R.color.colorWhite));
